...
const Testimonials = () => {
  return (
    <div className="testimonials">
      <img src={next_icon} alt="next icon" className="nxt-btn"  onClick={() => console.log("clicked nex")}/>
      <img src={back_icon} alt="back icon" className="back-btn"  onClick={() => console.log("clicked back")}/>
