        ...
        <ul>
          ...
          <li>
            <div className="slide">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae magnam accusamus error cum omnis vitae beatae maxime id? Commodi qui molestiae eveniet, error voluptatibus autem corporis nulla quam necessitatibus perferendis!</p>
            </div>
          </li>
          <li>
            <div className="slide">
